...
##    print stationTimeList
    ...
    print timeList, stationMDY
    if int(timeList[2]) < 10:

        currentMDY = str(timeList[1]) + ' ' + str('0') + str(timeList[2]) + ' ' + str(timeList[4])
    else:
...
jsonData = {'var =' + 'type': 'FeatureCollection', 'features': tenWarmJson}
